...
import com.zyff.util.JedisUtil;
...
public class JedisOperationTest {
	...
	public void testKey() throws InterruptedException {
		...
		System.out.println("查看 username的剩余生存时间:" + jedis.ttl("username"));
	...
	public void testNumber() {
		...
		System.out.println("将key1的值再加上整数5:" + jedis.incrBy("key1", 5));
		System.out.println("获取key1的值:" + jedis.get("key1"));
		System.out.println("将key2的值再减少整数5:" + jedis.decrBy("key2", 5));
		System.out.println("获取key2的值:" + jedis.get("key2"));
	}
	...
	public void testList() {
		...
		jedis.lpush("collections", "ArrayList", "Vector", "Stack", "HashMap", "WeakHashMap", "LikedHashMap");
		...
		System.out.println("修改collections指定下标1的内容:" + jedis.lset("collections", 1, "LikedArrayList"));
		System.out.println("collections的内容:" + jedis.lrange("collections", 0, -1));
