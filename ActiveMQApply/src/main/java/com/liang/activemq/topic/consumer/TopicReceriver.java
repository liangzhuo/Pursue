package com.liang.activemq.topic.consumer;
...
import com.liang.activemq.queue.consumer.QueueReceiver;

public class TopicReceriver {
	...
	public void start() {
		try {
			...
			// 消息到达的目的地
			destination = session.createTopic("text-msg");
			// 从session中，获取一个消息消费者
